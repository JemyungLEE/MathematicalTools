...
public class FRmethod {
	...
	public double[] searchDirection(double[] gv){
	...
	public double[] searchDirection(double[] oldS,double[] oldGv,double[] newGv){
		
		double[] s = new double[2];
		s[0] = -1.0*newGv[0]+Math.pow(newGv[0]/oldGv[0], 2)*oldS[0];
		s[1] = -1.0*newGv[1]+Math.pow(newGv[1]/oldGv[1], 2)*oldS[1];
	...
	public double[] process(double[] x, double e){
		...
		double newFx;
		double oldFx;
		double[] newGv = new double[2];
		double[] oldGv = new double[2];
		double[] newS = new double[2];
